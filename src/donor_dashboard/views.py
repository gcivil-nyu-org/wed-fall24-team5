...
def add_donation(request):
    ...
    messages.warning(request, f"Invalid Add Donation Request!")
    return redirect("/")
...
def modify_donation(request, donation_id):
    ...
    messages.warning(request, f"Invalid Modify Donation Request!")
    return redirect('donor_dashboard:manage_organization', organization_id=donation.organization_id)
...
def delete_donation(request, donation_id):
    ...
    if request.method == "POST":
        ...
        messages.success(request, f"Donation '{donation.food_item}' has been deleted successfully!")
        return redirect('donor_dashboard:manage_organization', organization_id=donation.organization_id)
    
    messages.error(request, f"Invalid Delete Donation Request!")
    return redirect('donor_dashboard:manage_organization', organization_id=donation.organization_id)