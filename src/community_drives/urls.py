...
urlpatterns = [
    ...
    path('participation-details/<uuid:organization_id>/<uuid:drive_id>/', views.get_participation_details, name='participation-details'),
    path('delete_participation/<uuid:organization_id>/<uuid:drive_id>/', views.delete_participation, name='delete-participation'),
]
